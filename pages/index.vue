    ...
    <template #default>
      <van-pull-refresh v-model="loading" @refresh="onRefresh">
        ...
        <template v-else-if="data && !pending">
            ...
            >
              ...
              <template #value>
                <div class="flex justify-end">
                  ...
                  <div class="w-32" :style="{ color: colorText(toNumber(pos.expectedYield)) }">
          ...
          <van-cell-group v-if="currencies.length" title="Валюта" inset>
            <van-cell
              v-for="pos in currencies"
              :key="pos.figi"
              :title="pos.name"
              label="RUB"
              :value="`${useMoneyFormatKopek(toNumber(pos.quantity))}`"
              center
            >
              <template #icon>
          ...
          <van-cell-group v-if="etfs.length" title="ETF" inset>
            <van-cell
              v-for="pos in etfs"
              :key="pos.figi"
              :title="pos.name"
